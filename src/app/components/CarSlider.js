                    ...
                    return <SwiperSlide key={index}>
                        <div className='max-w-[385px] mx-auto sm:mx-0'>
                            ...
                            <div className='flex justify-between'>
                                <div>
                                    <div className='text-[13px] text-secondary uppercase'>{car.typeof}</div>
                                    <h3 className='text-lg uppercase font-bold'>{car.name}</h3>
                                    <div className='mb-10 text-accent-DEFAULD font-semibold uppercase'>
                                        {car.price}/day
                                    </div>
                                </div>
                                {/* stars */}
                                <div className='flex gap-x-2 text-accent-DEFAULD h-max'>
                                    <FaStar/>
                                    <FaStar/>
                                    <FaStar/>
                                    <FaStar/>
